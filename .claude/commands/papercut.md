...
misleading error, a non-obvious gotcha, anything that took far longer than it
should have, or any solvable bump in the road. Not real bugs (those are issues), not
