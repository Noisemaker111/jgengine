...
|-----------|-----|-----------------|
| A 3D model (tree, astronaut) | `assets add astronaut --dir ../../apps/dev/public` | `catalog.resolve("quaternius-modular-scifi/astronautA")!.url` in an `entityModels`/`objectModels` seam |
