...
- `adjustStatPool` (const): const adjustStatPool: typeof changeStatPool — Preferred alias of {@link changeStatPool} — pure "adjust by amount" on a pool value. Use this name in new code (#1320 / sdk remediation Phase 1.1).
