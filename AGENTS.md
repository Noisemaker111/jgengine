...
- Each concept has one skill owner. `workflow` owns delivery, `fan-out` owns concurrency, `jgengine-verify` owns evidence, and domain skills own their package/API boundaries.
