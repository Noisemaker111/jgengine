...
2. **Work on your session's branch**, per the root workflow. If the carrier is a tracked issue, claim it first (`add_issue_comment`, `Working on this in Codex/<branch>`) before the token-heavy work.
