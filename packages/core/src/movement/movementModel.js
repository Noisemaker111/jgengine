 ...
 * movementInput.ts.
 */
export function createEmptyMovementKeys() {
 ...
 */
export function resolveMovementIntent(keys, canMove) {
    if (!canMove)
        return IDLE_INTENT;
...
function resolveTargetSpeed(intent, baseSpeed) {
 ...
 */
export function advancePlayerMotion(motion, intent, forwardX, forwardZ, baseSpeed, rawDeltaSeconds) {
...
export function cameraYawToAvatarBodyYaw(cameraYaw) {
