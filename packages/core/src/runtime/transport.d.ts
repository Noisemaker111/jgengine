...
export type GameRuntimeFeeds = {
    subscribeServer: (serverId: string, onChange: (view: GameRuntimeServerView | null) => void) => FeedUnsubscribe;
    subscribePlayer: (args: {
        serverId: string;
    }, onChange: (view: GameRuntimePlayerView | null) => void) => FeedUnsubscribe;
    subscribeFeed: (args: {
        serverId: string;
        action: string;
    }, onChange: (view: GameRuntimeFeedView) => void) => FeedUnsubscribe;
};
export type GameBackend<TPresenceRow = unknown, TPresenceLocation = unknown, TGameId extends string = string> = {
