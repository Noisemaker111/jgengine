...
/**
 * Deterministically place opaque items across `area`, grounded on the field. For
 * each grid cell it asks `layersFor` which items may appear in that region and
 * rolls one against their densities. The engine never interprets `item`.
 */
