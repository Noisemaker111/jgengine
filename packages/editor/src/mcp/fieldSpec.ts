...
export const RPC_FIELD_SCHEMAS: Record<EditorBridgeRequest["method"], readonly RpcFieldSpec[]> = {
  ...
  add_catalog: [req(s("catalogId")), s("label"), o("schema")],
  remove_catalog: [req(s("catalogId"))],
  set_catalog_schema: [req(s("catalogId")), req(o("schema")), s("label")],
  list_selection: [],
  get_marker: [req(s("id"))],
  get_volume: [req(s("id"))],
  ...
  add_marker: [req(s("id")), req(s("kind")), req(n("x")), n("y"), req(n("z")), s("color"), s("label"), n("rotationY"), s("catalogId"), o("meta")],
  set_marker: [req(s("id")), s("kind"), s("color"), s("label"), n("rotationY"), s("catalogId"), o("meta")],
