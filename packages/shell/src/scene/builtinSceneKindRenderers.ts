 ...
 * load so a document with a `water` volume renders without the game wiring anything up. Domain studios
 * (poles, …) register their own renderer via the public `registerSceneKindRenderer` — no edit here.
 */
