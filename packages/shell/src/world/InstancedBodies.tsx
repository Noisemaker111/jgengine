...
export interface InstancedBodiesProps {
  ...
  epoch?: number;
  /** Render only the first N bodies (e.g. leave trailing gameplay bodies to the entity path). Defaults to world.count. */
  count?: number;
}
 ...
 */
export function InstancedBodies({ world, debugTint = false, baseColors, epoch = 0, count }: InstancedBodiesProps) {
