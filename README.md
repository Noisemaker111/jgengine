...
| [`jgengine`](packages/jgengine) | Agent-side CLI (`npx jgengine`) — create, skills, doctor, desktop, llms. **People** do not start here; they tell an agent *Make a game that … with jgengine*. |
