  ...
  return (
    ...
    >
      ...
      >
        ...
        <h3
          className="absolute bottom-3 left-3 right-14 truncate rounded-lg border border-white/10 bg-black/40 px-2.5 py-1 text-[0.95rem] font-semibold tracking-tight text-slate-100 backdrop-blur-sm transition group-hover:text-white"
