  ...
  return (
    <group>
      <mesh position-y={0.05} castShadow>
        ...
        <meshStandardMaterial color="#fb4141" roughness={0.35} metalness={0.15} />
      </mesh>
      <mesh position={[0, 0.42, -0.25]} castShadow>
        <boxGeometry args={[1.35, 0.4, 1.4]} />
        <meshStandardMaterial color="#1c2733" roughness={0.15} metalness={0.4} />
      </mesh>
      <mesh position={[0, 0.05, 1.68]}>
        <boxGeometry args={[1.3, 0.18, 0.1]} />
        <meshStandardMaterial color="#fff7d6" emissive="#fff2b0" emissiveIntensity={1.4} />
      </mesh>
      <mesh position={[0, 0.05, -1.68]}>
        <boxGeometry args={[1.3, 0.18, 0.1]} />
        <meshStandardMaterial color="#7a0d0d" emissive="#ff2d2d" emissiveIntensity={1.1} />
      </mesh>
