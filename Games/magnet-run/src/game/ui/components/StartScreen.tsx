...
export function StartScreen() {
  ...
  return (
    <MenuScreen className="flex max-w-md flex-col items-center gap-5 rounded-lg border border-[#dfe6ee]/15 bg-[#20242a]/95 px-8 py-7 text-center shadow-2xl">
      ...
      <ControlsList
        ...
        className="grid w-full grid-cols-2 gap-x-4 gap-y-1.5 text-left text-xs text-[#dfe6ee]/80"
        rowClassName="flex items-center gap-2"
        keyClassName="rounded border border-[#dfe6ee]/40 bg-[#2b2f36] px-1.5 py-0.5 font-mono text-[10px]"
      />
      <button
        type="button"
