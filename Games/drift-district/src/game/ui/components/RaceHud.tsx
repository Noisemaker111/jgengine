...
export function RaceHud({ snapshot }: { snapshot: SessionSnapshot }) {
  ...
  return (
    <>
      ...
      <SettingsTrigger className="pointer-events-auto absolute right-4 top-4 flex h-9 w-9 items-center justify-center rounded-lg border border-[#e8e6f0]/15 bg-[#15151d]/85 text-[#e8e6f0] shadow-[0_0_24px_rgba(0,0,0,0.5)] transition-colors hover:bg-[#e8e6f0]/15" />
    </>
  );
}
