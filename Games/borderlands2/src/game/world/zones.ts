...
export const ZONES: readonly ZoneDef[] = [
  ...
  },
  {
    ...
    clusters: [
      { catalogId: "psycho", count: 5, offset: { x: 70, z: -40 }, radius: 22 },
      { catalogId: "marauder", count: 4, offset: { x: 70, z: -40 }, radius: 22 },
      { catalogId: "nomad", count: 2, offset: { x: 110, z: 20 }, radius: 16 },
      { catalogId: "bullymong", count: 3, offset: { x: -80, z: 60 }, radius: 20 },
    ],
    chests: [
  ...
  },
  {
    ...
    clusters: [
      { catalogId: "skag_pup", count: 5, offset: { x: -70, z: 110 }, radius: 20 },
      { catalogId: "skag", count: 4, offset: { x: -70, z: 110 }, radius: 20 },
      { catalogId: "badass_skag", count: 1, offset: { x: -70, z: 110 }, radius: 12 },
      { catalogId: "psycho", count: 5, offset: { x: 120, z: 60 }, radius: 24 },
      { catalogId: "marauder", count: 4, offset: { x: 120, z: 60 }, radius: 24 },
      { catalogId: "badass_psycho", count: 1, offset: { x: 120, z: 60 }, radius: 12 },
    ],
    chests: [
      { kind: "red", x: 90, z: 55 },
      { kind: "ammo", x: 16, z: -46 },
  ...
  },
  {
    ...
    clusters: [
      ...
      { catalogId: "spiderant", count: 5, offset: { x: 80, z: 70 }, radius: 22 },
      { catalogId: "spiderant_soldier", count: 3, offset: { x: 80, z: 70 }, radius: 18 },
    ],
    chests: [
  ...
  },
  {
    ...
    clusters: [
      { catalogId: "spiderant", count: 4, offset: { x: -90, z: 40 }, radius: 22 },
      { catalogId: "spiderant_soldier", count: 3, offset: { x: -90, z: 40 }, radius: 18 },
      { catalogId: "badass_psycho", count: 2, offset: { x: 70, z: -60 }, radius: 18 },
      { catalogId: "marauder", count: 5, offset: { x: 70, z: -60 }, radius: 24 },
      { catalogId: "nomad", count: 3, offset: { x: 10, z: 90 }, radius: 18 },
    ],
    chests: [
  ...
  },
  {
    ...
    clusters: [
      { catalogId: "loader", count: 5, offset: { x: 60, z: 40 }, radius: 22 },
      { catalogId: "loader_war", count: 3, offset: { x: 60, z: 40 }, radius: 18 },
      { catalogId: "loader", count: 4, offset: { x: -80, z: -50 }, radius: 22 },
      { catalogId: "badass_loader", count: 1, offset: { x: -80, z: -50 }, radius: 12 },
    ],
    chests: [
      { kind: "red", x: -20, z: -510 },
