...
export const CHARACTERS: readonly CharacterDef[] = [
  {
    ...
    nodes: [
      ...
      node("sal_come_at_me", "brawn", "Come At Me Bro", "Second Winds restore +50% more health", 1, { secondWindHeal: { add: 0.5 } }, 10),
  ...
  },
  {
    ...
    nodes: [
      ...
      node("maya_res", "harmony", "Res", "Second Winds fully restore your shield and +40% health", 1, { secondWindHeal: { add: 0.4 } }, 10),
