...
export const SHOP_ID = "shop_pandora";
...
export const gearItems: readonly GearDef[] = [
  ...
  { id: "insta_health", name: "Insta-Health Vial", kind: "health", use: "useHealthVial", heal: 35, trade: { buy: { cash: 45 }, shops: ["shop_pandora"] } },
  { id: "insta_health_big", name: "Big Insta-Health", kind: "health", use: "useHealthVial", heal: 80, trade: { buy: { cash: 110 }, shops: ["shop_pandora"] } },
  { id: "shield_upgrade", name: "Capacitive Shield Booster", kind: "shield_mod", use: "useShieldBooster", shieldBonus: 25, trade: { buy: { cash: 220 }, shops: ["shop_pandora"] } },
];
