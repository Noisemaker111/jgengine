...
- `.claude/skills/jgengine-api/SKILL.md` (+ `reference/world.md`, `reference/multiplayer.md`)
- `.claude/skills/jgengine-newgame/SKILL.md`
- `.claude/skills/jgengine-verify/SKILL.md`
