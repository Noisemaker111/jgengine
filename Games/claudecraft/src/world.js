import { building, environment, grass, rain, sky, snow, terrain, } from "@jgengine/core/world/features";
...
export const world = environment({
    ...
    structures: [
        ...
        ...compounds.map((dungeon) => building({
...
export const physics = { gravity: -16, jumpVelocity: 6 };
