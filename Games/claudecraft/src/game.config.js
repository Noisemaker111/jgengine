...
import { AUCTION_BOARD, contentPrompts, DELVE_PORTAL, dungeonPrompts, MAILBOX, npcPrompts, strongboxPrompts, STRONGBOX, VALE_CUP_STADIUM, YUMI_SHRINE, } from "./game/world/setup";
...
const objectStyles = {
    ...
    ...Object.fromEntries(GATHER_NODES.map((node) => [node.id, { color: NODE_COLORS[node.profession] ?? "#888888" }])),
};
