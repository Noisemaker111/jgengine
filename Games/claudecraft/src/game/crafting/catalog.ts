...
export const FISH_TABLE: readonly { itemId: string; weight: number; minSkill: number }[] = [
...
export const FISHING_SPOTS: readonly { id: string; zone: "vale" | "marsh" | "peaks"; position: readonly [number, number] }[] = [
