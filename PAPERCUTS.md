...
gate/test:all in the cloud container → 3 model-pack texture-URI tests fail identically on origin/main (previously alongside a Windows tar drive-letter issue, since fixed); needs a look at the pack tests
