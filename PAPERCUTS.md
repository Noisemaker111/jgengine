...
2026-07-18T03:54:26.359Z — claude-fable-5 — Claude

auditing the papercut pipeline → all 93 existing PAPERCUTS.md entries were double-encoded mojibake (— as â€”, → as â†’) even though scripts/papercut.ts writes clean UTF-8; likely an older writer or a latin-1 shell pass — repaired with sed, worth watching for recurrence
