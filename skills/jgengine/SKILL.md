---
name: jgengine
description: Use whenever the user asks to make, build, change, or understand a game with JGengine or jgengine.com. Identifies the game quickly, records an actionable intake, and routes only to the engine domains the work needs.
---
