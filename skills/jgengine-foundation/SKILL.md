---
name: jgengine-foundation
description: Core JGengine project setup and runtime reference. Read for every JGengine task: packages, defineGame, PlayableGame, GameContext, lifecycle, time, catalogs, state, input, and project shape.
---
...
The engine ships **verbs and primitives**; your game ships **nouns** (catalogs) and thin handlers. Start from `jgengine` for intake and selective routing, use this foundation before implementation, and use `jgengine-verify` afterward. UI guidance lives in [`../jgengine-ui/reference.md`](../jgengine-ui/reference.md); assets live in `jgengine-assets`.
