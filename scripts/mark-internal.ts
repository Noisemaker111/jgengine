...
const FILES = [
  ...
  "packages/core/src/inventory/inventoryModel.ts",
  "packages/core/src/input/actionBindings.ts",
  "packages/core/src/input/axisInput.ts",
  "packages/core/src/game/worldItem.ts",
  "packages/core/src/game/trade.ts",
  "packages/core/src/combat/telegraph.ts",
  "packages/core/src/economy/currency.ts",
  "packages/core/src/random/seedLink.ts",
  "packages/shell/src/inputSink.ts",
  "packages/shell/src/commandSink.ts",
  "packages/shell/src/behaviour.ts",
  "packages/shell/src/behaviourAttach.ts",
  "packages/shell/src/behaviourDriver.ts",
  "packages/shell/src/worldSync.ts",
  "packages/react/src/selectSnapshot.ts",
  "packages/react/src/skillCheckPaint.ts",
  "packages/react/src/fogOverlay.ts",
  "packages/react/src/display.ts",
  "packages/react/src/engineStore.ts",
  "packages/react/src/preview.ts",
  "packages/convex/src/occ.ts",
  "packages/convex/src/hostedServer.ts",
